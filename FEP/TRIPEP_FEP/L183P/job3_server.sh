...
do
    ...
    gmx mdrun -nt 28 -ntmpi 28 -npme 1 -deffnm nvt_lam$LAMBDA
    ...
    gmx mdrun -nt 28 -ntmpi 28 -npme 1 -deffnm npt_lam$LAMBDA
    ...
    gmx mdrun -nt 28 -ntmpi 28 -npme 1 -deffnm md_lam$LAMBDA
